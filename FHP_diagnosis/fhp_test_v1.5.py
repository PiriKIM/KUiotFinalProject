...
# ✅ Tragus 위치 미세 보정 (더 왼쪽, 더 위)
def estimate_tragus_xy_precise(ear_landmark, image_w, image_h):
    x_offset = -0.04  # 기존 -0.035 → 더 왼쪽으로
    y_offset =  0.00  # 기존 0.02 → 위쪽으로 회복
...
while cap.isOpened():
    ...
    cv2.imshow('Posture Diagnosis (v1.5 - fine adjusted)', frame)
